export const UX_ERRORS = {
  AUTH: {
    ...
    INVALID_SECRET:
      'The provided secret code for staff registration is invalid.',
    WEAK_PASS:
  ...
  CRUD: {
    ...
    HIERARCHY_VIOLATION:
      'Action blocked. You cannot modify accounts at this permission level.',
  ...
  FINANCE: {
    ...
    PAYROLL_REQ_EMP:
      'A recipient employee is required for Payroll transactions.',
  },
  COMPLAINT: {
