...
export const getUserAnalytics = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, data, 'User analytics fetched'));
});
...
export const getDocAnalytics = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, data[0], 'Doc analytics fetched'));
});
...
export const getComplaintAnalytics = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, data, 'Complaint analytics fetched'));
});
