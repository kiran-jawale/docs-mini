...
const ModDocs = () => {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-black dark:text-white uppercase tracking-tight">
          Staff Oversight
        </h1>
      ...
      {loading ? (
        ...
        <>
          {currentView === "#users" && (
            <UserTable users={data} refresh={loadModData} isModView={true} />
          )}
          {currentView === "#complaints" && (
            <ComplaintTable complaints={data} refresh={loadModData} />
          )}
          {currentView === "#documents" && (
            <DocumentTable docs={data} refresh={loadModData} isAdmin={false} />
          )}{" "}
