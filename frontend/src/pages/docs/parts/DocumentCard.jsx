      ...
      <div className="footer absolute bottom-0 w-full left-0">
        <div className="flex items-center justify-between px-8 py-3 mb-3">
          <h5 className="text-[10px] text-gray-500 font-mono">
            {isOwner
              ? "YOU"
              : data.owner?.fullname?.split(" ")[0].toUpperCase() || "STAFF"}
          </h5>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="w-7 h-7 bg-zinc-800 rounded-full flex items-center justify-center hover:bg-zinc-700 text-[10px]"
            >
              👁️
            </button>
            ...
            {isOwner && (
              <button
                ...
                className="w-7 h-7 bg-zinc-800 rounded-full flex items-center justify-center hover:bg-blue-600 text-[10px]"
              >
                ✏️
              </button>
            )}
            ...
            {(isOwner || isStaff) && (
              <button
                ...
                className="w-7 h-7 bg-zinc-800 rounded-full flex items-center justify-center hover:bg-red-600 text-[10px]"
              >
                🗑️
              </button>
            )}
        ...
        <div
          ...
          className={`w-full py-4 ${colorClass} flex items-center justify-center cursor-pointer hover:brightness-110 transition-all`}
        >
