      ...
      <div className="max-w-6xl mx-auto py-16 px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-500 font-medium max-w-xl mx-auto">
            Have a question about your documents or need technical support? Our
            regional offices are here to help 24/7.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            ...
            />
            <ContactCard icon="📞" title="Phone" detail="+91 1234567890" />
          </div>
            ...
            {status ? (
              ...
              <div className="h-full flex flex-col items-center justify-center bg-zinc-100 dark:bg-zinc-800/40 p-12 rounded-[2.5rem] border-2 border-dashed border-zinc-200 dark:border-zinc-700 text-center">
                ...
                <p className="text-zinc-500 text-sm mb-8 max-w-xs">
                  To protect your data and verify your identity, support tickets
                  can only be raised by registered members.
                </p>
                <Link
                  to="/auth"
                  className="btn-primary px-10 py-3 rounded-2xl text-xs font-black tracking-widest uppercase"
                >
