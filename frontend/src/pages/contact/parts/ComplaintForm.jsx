...
const ComplaintForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast(
        "Ticket raised successfully! Check your notifications for updates.",
        "success"
      );
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex items-center justify-between pt-2">
        <p className="text-[9px] text-zinc-400 max-w-[200px]">
          Your region (
          <span className="text-green-600 font-bold">{user?.regionCode}</span>)
          will be automatically tagged for faster routing.
        </p>
        <button
          type="submit"
          disabled={loading}
