  ...
  return (
    <div className="space-y-8">
      <div className="flex gap-4 bg-white dark:bg-zinc-900 p-2 rounded-2xl border dark:border-zinc-800 w-fit">
        <select
          className="bg-transparent text-[10px] font-black uppercase px-4 py-2 text-zinc-500 outline-none"
        ...
        <select
          className="bg-transparent text-[10px] font-black uppercase px-4 py-2 text-zinc-500 border-l dark:border-zinc-800 outline-none"
        ...
        <div className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-zinc-900 dark:bg-white p-8 rounded-3xl text-white dark:text-black shadow-xl">
              ...
              <p className="text-5xl font-black mt-2">
                {(
                  (data?.totalStats[0]?.totalBytes || 0) /
                  (1024 * 1024)
                ).toFixed(2)}{" "}
                MB
              </p>
