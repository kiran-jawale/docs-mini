  ...
  return (
    <Container>
      <div className="mb-10 flex items-center justify-between">
        <div>
          <h1 className="text-5xl font-black text-zinc-900 dark:text-white tracking-tighter uppercase leading-none">
            BI Console
          </h1>
      ...
      <div className="mt-8">
        {currentHash === "#users" && user?.role === "admin" && (
          <UserAnalytics />
        )}
        {currentHash === "#docs" && user?.role === "admin" && <DocAnalytics />}
        {currentHash === "#complaints" && user?.role === "admin" && (
          <ComplaintAnalytics />
        )}
