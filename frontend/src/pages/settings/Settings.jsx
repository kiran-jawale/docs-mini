...
const Settings = () => {
  ...
  const handleSetUserID = async (e) => {
    ...
    if (newUserID.length !== 8)
      return addToast("User ID must be 8 characters", "error");
    setLoading("userid");
    try {
  ...
  return (
    <Container>
      <div className="max-w-4xl mx-auto py-12 px-6">
        <h1 className="text-4xl font-black mb-10 dark:text-white tracking-tighter uppercase">
          Account Security
        </h1>
          ...
          <section className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm">
            ...
            <form onSubmit={handleUpdateEmail} className="space-y-4">
              ...
              <button
                ...
                className="btn-primary py-2 text-[10px] font-black uppercase"
              >
          ...
          <section className="bg-white dark:bg-zinc-900 p-8 rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm">
            ...
            <form onSubmit={handleSetUserID} className="space-y-4">
              <input
                type="text"
                maxLength={8}
                className="input-field font-mono uppercase text-center"
                value={newUserID}
                placeholder="8-CHAR ALPHANUMERIC"
            ...
            >
              ...
              <div className="md:col-span-2 flex justify-end">
                <button
                  ...
                  className="btn-primary py-3 px-12 text-[10px] font-black uppercase"
                >
                  {loading === "password"
                    ? "Updating Security..."
                    : "Update Password"}
